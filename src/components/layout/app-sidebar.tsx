      ...
      {tier !== 'PRO' && (
        <div className="px-3 pb-2">
          <div className="rounded-md border border-zinc-800 bg-zinc-950 px-3 py-2.5 flex items-center justify-between gap-2">
            <div>
              <p className="text-xs font-semibold text-zinc-400">{tier === 'FREE' ? 'Free plan' : 'Scout plan'}</p>
              <p className="text-xs text-zinc-600">{tier === 'FREE' ? 'Upgrade for more' : 'Upgrade to Pro'}</p>
            </div>
            <button
