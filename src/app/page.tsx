      ...
      <section className="max-w-5xl mx-auto px-6 pt-24 pb-20">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold text-amber-400 uppercase tracking-widest mb-6">
            AI-powered watch buying assistant
          </p>
          ...
          <p className="text-lg text-zinc-400 leading-relaxed mb-10 max-w-xl">
            ...
            ranking every listing against your preferences, generating the questions that surface
            the truth, and re-ranking in real time as you learn more.
          </p>
